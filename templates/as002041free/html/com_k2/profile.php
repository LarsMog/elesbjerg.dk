		...
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="key">
					...
					<label for="del_image" style="width: 80%;"><?php echo JText::_('K2_CHECK_THIS_BOX_TO_DELETE_CURRENT_IMAGE_OR_JUST_UPLOAD_A_NEW_IMAGE_TO_REPLACE_THE_EXISTING_ONE'); ?></label>
					<?php endif; ?>
				</td>
			</tr>
			<tr>
