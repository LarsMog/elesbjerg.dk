  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemVideo">
      	<?php echo $item->video ; ?>
        <div class="moduleItemVideoCaption"><?php echo $item->video_caption ; ?></div>
        <div class="moduleItemVideoCredits"><?php echo $item->video_credits ; ?></div>
      </div>
