...
<div class="row">
	<?php if (!isset($images->image_intro) OR empty($images->image_intro)) : ?>
		<?php $images->image_intro = '/images/logo.png';
			$images->image_intro_alt = 'Enhedslisten'; ?>
	...
	<?php endif; ?>
		...
		<div class="col-md-2">
			 <img
				...
				src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt); ?>" style="width:100%"/>
		</div>
		<div class="col-md-10">
